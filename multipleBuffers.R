...
# 
# # only used by vitis
# ga50 <- rast("data/Vitis/Vitis acerifolia/run08282025_1k/results/ga50.tif"  )
# natArea <- sf::st_read("data/Vitis/Vitis acerifolia/run08282025_1k/results/naturalArea.gpkg" )
# nativeArea<- sf::st_read("data/Vitis/Vitis acerifolia/run08282025_1k/results/naturalArea.gpkg" )
...
#   #                   geom = c("longitude", "latitude"))
#   # terra::crs(d1) <- "epsg:4326"
#   # crop the ecoregions to the points 
#   # eco1 <- ecoregions[d1,]
#   
