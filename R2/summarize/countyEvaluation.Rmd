...
<br>
**Relationship to Flora of North America**: `r s1$s1$Relationship_to_FNA`
<br>
...
- Herbarium data : Occurrence data with associated herbarium specimens
...
bpData <- countyClass |>
  ...
  dplyr::filter(anyRecord ==1 | anyRecord == 2)
...
# add spatial features to map
  ...
  addLayersControl(
      overlayGroups = c("All Records","Observation", "Herbarium", "Germplasm","Plants or Bonap Only","H or G record","Observation only"),
      options = layersControlOptions(collapsed = FALSE)
    )|>
  hideGroup(c("Observation","Herbarium","Germplasm","Plants or Bonap Only","H or G record","Observation only"))
}
...
df <- countyClass |>
  ...
  dplyr::select(-allColor, -inCountyData, -fips2 ,-popup)|>
