...
# add spatial features to map
  m2 <- m1 |>
    ...
    addCircleMarkers(data = h_no_url,
             ...
             stroke = 1,
             popup = ~popup,
             group = "Herbarium without web content",
             options = pathOptions(pane = "points")
               )|>
    addCircleMarkers(data = h_url,
         ...
         stroke = 1,
         popup = ~popup,
         group = "Herbarium with web content",
         options = pathOptions(pane = "points")
           )|>
...
m3 <- m2 |>
    ...
    addLegend(color = "#fec44f",
              group = "Plants or Bonap Only",
              labels = "Plants or Bonap only county")|>
      # legend for the h or g 
    addLegend(color = "#fa9fb5",
              group = "H or G record",
              label = "H or G record in county")|>
      # legend for the observation only 
    addLegend(color = "#f03b20",
              group = "Observation only",
              labels = "Observation only county")|>
    # legend for the G
    addLegend(color = "#66c2a5",
              group = "Germplasm",
              labels = "Germplasm points")|>
    # legend for the H with
    addLegend(color = "#c51b8a",
              group = "Herbarium with web content",
              labels = "Herbarium points with web content")|>
  # legend for the H without
    addLegend(color = "#fa9fb5",
              group = "Herbarium without web content",
              labels =  "Herbarium points without web content")|>
  # legend for the O
    addLegend(color = "#fc8d62",
              labels = "Observation points",
              group = "Observation")|>
  addLayersControl(
      overlayGroups = c("Any records", "Sum of records", "Plants or Bonap Only","H or G record","Observation only",
                        "Germplasm", "Herbarium with web content","Herbarium without web content", "Observation"),
    ...
    #     }
    # ")|>
  hideGroup(c("Sum of records", "Plants or Bonap Only","H or G record","Observation only", 
              "Herbarium with web content","Herbarium without web content", "Observation",  "Germplasm"))
