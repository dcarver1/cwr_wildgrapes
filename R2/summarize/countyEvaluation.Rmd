...
# for testing
# speciesName <- "Vitis rufotomentosa"
## troubleshooting  
...
names(s1) <- c("taxon",
               "acceptedSynonym",
               "Names_to_exclude_from_this_Species_Complex",
               "Species_Complex", 
               "NatureServe_Concept_reference",
               "Relationship_to_FNA",
               "Taxonomic_notes",
               "Classification_Status_NatureServe",
               "Number_of_lower_taxa",
               "Careful_review_needed?",
               "Extralimital_to_US/Canada_(nativerange)")
