...
varTable <- data$variableImportance |>
  dplyr::select("Predictor Variable" = `Current title`,
                "Relative Important on Model" = importance,
                "Included in model" = includeInFinal,
                "Abbrevaition" = varNames
                )|>
  dplyr::arrange(desc(`Relative Important on Model`))|>
  dplyr::arrange(desc(`Included in model`))
# display table 
...
**Herbarium Records(H)** : Occurrences that have a supporting herbarium or other reference record.
