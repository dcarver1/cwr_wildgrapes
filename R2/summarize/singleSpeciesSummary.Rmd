...
grsinColor <- colorNumeric(palette = c("#FFFFFF80", "#45b320", "#7570b3"),
...
if (class(gBuf) != "character") {
  ...
  grsexColor <- colorNumeric(palette = c("#FFFFFF80", "#45b320", "#7570b3"),
                 # purple is a little lighter so the point locations show up clearly
...
srsPal1 <-  c("#FFFFFF95",
    ...
    "#225ea8",
    "#0c2c84")
srsPal <- colorNumeric(palette = c("#FFFFFF95","#7fcdbb","#41b6c4","#1d91c0","#225ea8","#0c2c84"),
               domain = values(srs1),
               alpha = TRUE,
               na.color = "transparent")
