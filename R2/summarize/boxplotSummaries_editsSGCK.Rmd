---
title: Ecogeographic characterization summary
...
# need to include the intraspecific data as part of the aestivalis and cinerea, going to just duplicated these records and rename the taxa... 
aestivalis <- c("Vitis aestivalis var. aestivalis", "Vitis aestivalis var. bicolor")
cinerea <- c("Vitis cinerea var. cinerea","Vitis cinerea var. tomentosa")

# pull records 
a1 <- data |> 
  dplyr::filter(taxon %in% aestivalis) |>
  dplyr::mutate(taxon = "Vitis aestivalis")
c1 <- data |> 
  dplyr::filter(taxon %in% cinerea) |>
