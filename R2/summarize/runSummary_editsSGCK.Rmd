---
title: Distributions and conservation gap analysis summary
...
All germplasm records utilized in the *ex situ* conservation assessments can be found within the Supplementary Material associated with the publication or through this  [link](https://docs.google.com/spreadsheets/d/1a0GRbN4O4UCVcOV-OXECcWiiQtmkfPOU/edit?gid=2052151280#gid=2052151280)
...
richness1 <- leaflet(width = "100%", options = leafletOptions(minZoom = 3)) |>
  ...
  leaflet::addLegend(position = "bottomright",
            ...
            group = "Species Richness" # Updated to match raster group
            )|>
  addLayersControl(
