...
Shows the number of species present in every protected area that contains at least one species project habitat 
```{r echo=FALSE, message=FALSE, warning=FALSE}
# probably want to process this outside of the rendering of the document. '
pc1 <- protectCounts |>
  dplyr::filter(totalSpecies != 0) |>
