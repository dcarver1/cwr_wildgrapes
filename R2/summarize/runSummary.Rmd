...
All conservation gap analysis scores per Vitis taxa, with ex situ scores as circles, in situ scores as triangles, and the combined FCSc-mean score as diamonds. Scores are used to categorize taxa, with urgent priority (UP) for further conservation action assigned when score < 25, high priority (HP) where 25 ≤ score < 50, medium priority (MP) where 50 ≤ score < 75, and low priority (LP) for taxa whose score ≥75
