...
# add spatial features to map
  m2 <- m1 |>
    ...
    addPolygons(data = countyClass,
                color = "white",
                fillColor =~palWeighted(weightedSum),
                popup = ~popup,
                weight = 0.8,
                fillOpacity = 0.6,
                opacity = 0.8,
    ...
    addLegend(pal = palAll, 
              values = countyClass$anyRecord[!is.na(countyClass$anyRecord)],
              group = "All Records",
              title = "All Records Counted")|>
    addLegend(pal = palWeighted, 
              values = countyClass$weightedSum[!is.na(countyClass$weightedSum)],
              na.label = NA,
              group = "Weighted Records",
